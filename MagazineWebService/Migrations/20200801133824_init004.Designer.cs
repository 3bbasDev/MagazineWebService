...
namespace MagazineWebService.Migrations
{
    ...
    [Migration("20200801133824_init004")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MagazineWebService.Infrastructure.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Link = "asdasda;123wqeq",
                            Logo = "1111111111",
                            Name = "asdasd",
                            PhoneNumber = "asdasda;123wqeq",
                            SlidShow = "asdasda;123wqeq",
                            Views = 0
                        });
                });
            ...
            modelBuilder.Entity("MagazineWebService.Infrastructure.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Ali",
                            Password = "bAq8hg9NtUywwHH8UcooUWyIYzPGHKfA/cv3UYc+keYJ4qVd",
                            PolicyId = 1,
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("MagazineWebService.Infrastructure.Section", b =>
                {
                    b.HasOne("MagazineWebService.Infrastructure.Section", "Parent")
                        .WithMany("Sections")
